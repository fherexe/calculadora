...
const buttons = document.querySelectorAll ('button'); // Retorna uma lista de elementos dentro do doeucmento //
...
buttons.forEach((btn) => {
    btn.addEventListener ("click", () => {
        if (btn.id === "=")  {
            ...
            display.value = display.value.slice(0,-1) //.slice apagar caracteres //
        } else {
